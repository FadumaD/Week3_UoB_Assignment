...
function generatePrompts() {
    choiceArr = [];
 characterlength = parseInt(prompt("How many characters would you like in your password?(8 - 128 character")); //NaN
  if(isNaN(characterlength) || characterlength < 8 || characterlength > 128) { // i hope that this is all false 
